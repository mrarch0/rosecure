// PRODUCTION WORKER - Full lockdown on rosecure.org
// Staging is on a separate branch, protected by Cloudflare Zero Trust
...
export default {
  async fetch(request, env) {
    try {
      ...
      // Serve normal assets for other environments
